...
export const RBAC_MATRIX: PermissionMatrix[] = [
  ...
  { role: 'ADMIN', page: '/ar/admin/system', expectedStatus: 200 },
  ...
  { role: 'SUPPORT', page: '/ar/admin/users', expectedStatus: 200 },
  { role: 'SUPPORT', page: '/ar/admin/wallet/requests', expectedStatus: 200 },
  { role: 'SUPPORT', page: '/ar/admin/system', expectedStatus: 200 },
  ...
  { role: 'COMPANY_ADMIN', page: '/ar/admin/users', expectedStatus: 200 },
  { role: 'COMPANY_ADMIN', page: '/ar/admin/listings', expectedStatus: 200 },
  { role: 'COMPANY_ADMIN', page: '/ar/admin/wallet/requests', expectedStatus: 200 },
  ...
  { role: 'SELLER', page: '/ar/admin', expectedStatus: 200 },
  { role: 'SELLER', page: '/ar/dashboard/company', expectedStatus: 200 },

  // Personal Buyer
  { role: 'USER', page: '/ar/dashboard', expectedStatus: 200 },
  { role: 'USER', page: '/ar/dashboard/wallet', expectedStatus: 200 },
  { role: 'USER', page: '/ar/dashboard/seller', expectedStatus: 200 },
  { role: 'USER', page: '/ar/dashboard/company', expectedStatus: 200 },
  { role: 'USER', page: '/ar/admin', expectedStatus: 200 },
  { role: 'USER', page: '/ar/admin/users', expectedStatus: 200 },
];